...
using NiceAdmin_Theme.Areas.LOC_City.Models;
using NiceAdmin_Theme.Areas.LOC_Country.Models;
using NiceAdmin_Theme.Areas.LOC_State.Models;

// For more information on enabling MVC for empty projects, visit https://go.microsoft.com/fwlink/?LinkID=397860

namespace NiceAdmin_Theme.Areas.LOC_City.Controllers
{
    [Area("LOC_City")]
